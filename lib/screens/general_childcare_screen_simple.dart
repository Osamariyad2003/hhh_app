...
class GeneralChildcareScreenSimple extends StatefulWidget {
  ...
  @override
  State<GeneralChildcareScreenSimple> createState() => _GeneralChildcareScreenSimpleState();
}

class _GeneralChildcareScreenSimpleState extends State<GeneralChildcareScreenSimple> {
  ...
  Widget build(BuildContext context) {
    ...
    print('🔍 CHILDCARE SCREEN: Building with ${items.length} items for lang=$language, category=$_selectedCategory');
